...
import com.example.foodfreak.com.foodfreak.main.user.Home_page;
...
public class admin_login extends AppCompatActivity {
        ...
        signup_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(admin_login.this, pairs);
    ...
    private void signInTheUserByCredential(PhoneAuthCredential credential)
    {
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(admin_login.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful())
                {
                    Toast.makeText(admin_login.this, "Login Successful", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(admin_login.this, Admin_home_page.class));
        ...
        referenceUser.orderByChild("manager_contact_num").equalTo(mobile_num_str).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.getValue() != null) {
                    ...
                    Toast.makeText(admin_login.this,"We have sent 6 digit OTP via SMS",Toast.LENGTH_SHORT).show();
